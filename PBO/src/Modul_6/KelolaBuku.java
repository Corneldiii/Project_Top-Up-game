...
public class KelolaBuku {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < Buku.length; i++) {
            ...
            jumpe=Integer.parseInt(JOptionPane.showInputDialog(null,"Masukan jumlah pengarang"));
        ...
        DataPengarang baru=new DataPengarang("Abdul", "JL.Sama aku","2141123");
        Buku[n-1].addPengarang(jumpe-1, baru);
        ...
        int cari=Integer.parseInt(JOptionPane.showInputDialog(null, "Masukan angka untuk dicar "));
        add.cariTahun(cari, Buku);
