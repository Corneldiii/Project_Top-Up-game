    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < A.length; i++) {
            ...
            if(jab==1){//jika isi variable jab sam adengan 1
                ...
                ((manajer)A[i]).setNpp(npp);;//mengset npp kedalam A[i] yang bertipe manajer
                ((manajer)A[i]).setGapok(gaji);;//mengset gapok kedalam A[i] yang bertipe manajer
                ((manajer)A[i]).setLembur(lembur);;//mengset lembur kedalam A[i] yang bertipe manajer
                ((manajer)A[i]).setTunJab(tun);;//mengset tunjangan jabatan kedalam A[i] yang bertipe manajer
        ...
        for (int j = 0; j < A.length; j++) {
            ...
            if(A[j] instanceof manajer){//jika array of objek a bersifat manajer
                ...
                tunjangan = man1.getTunJab()+man1.getLembur();//menghitung tunjangan dengan memanggil method getTunJab dan getLembur
            ...
            //mencetak setiap gaji pokok tunjangan dan gaji total dari setiap array of objek A
